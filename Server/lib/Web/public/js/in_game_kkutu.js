(function() {
	...
	function renderMoremi(a, b, r) {
		...
		if(b.MSKIN == "hide_moremi"){
			for (c in MOREMI_PART) d = "M" + MOREMI_PART[c], e.append($("<img>").addClass("moremies moremi-" + d.slice(1)).attr("src", "/img/kkutu/def.png").css({
				width: "100%",
				height: "100%"
			}));
			return;
	...
	var MODE, BEAT = [null, "10000000", "10001000", "10010010", "10011010", "11011010", "11011110", "11011111", "11111111"],
		...
		OSV = new RegExp(["끄투코리아","끄코","끄투닷컴","끄닷","끄투리오","끄투한국","끄리","끄한","태풍끄튬","태풍끄툼","태풍끄투","분홍끄투","투데이끄투","이름없는끄투","이름 없는 끄투","이름없는 끄투","이름 없는끄투","김대운"].join("|")),
		ws, rws, $stage, $sound = {},
		$_sound = {},
		$data = {},
		$lib = {
