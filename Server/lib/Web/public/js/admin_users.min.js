		...
		$("#user-go").on("click", function(b) {
			$.get("/gwalli/users?id=" + $("#user-id").val() + "&name=" + $("#user-nick").val(), function(b) {
				...
				b.list.forEach(function(b) {
					d.append(c = $("<tr>").attr("id", ["ur", b._id].join("-"))), c.append($("<td>").append(a("ud-" + b._id + "-_id", "g", b._id))).append($("<td>").append(a("ud-" + b._id + "-money", "g", b.money))).append($("<td>").append(a("ud-" + b._id + "-kkutu", "l", JSON.stringify(b.kkutu || {})))).append($("<td>").append(a("ud-" + b._id + "-box", "l", JSON.stringify(b.box || {})))).append($("<td>").append(a("ud-" + b._id + "-equip", "l", JSON.stringify(b.equip || {})))).append($("<td>").append(a("ud-" + b._id + "-nickname", "g", b.nickname))).append($("<td>").append(a("ud-" + b._id + "-server", "t", b.server))).append($("<td>").append(a("ud-" + b._id + "-lastLogin", "t", b.lastLogin))).append($("<td>").append(a("ud-" + b._id + "-black", "g", b.black))).append($("<td>").append(a("ud-" + b._id + "-friends", "g", JSON.stringify(b.friends || {}))))
				})
			})
