		...
		$("#user-go").on("click", function(b) {
			$.get("/gwalli/users?id=" + $("#user-id").val() + "&name=" + $("#user-nick").val(), function(b) {
				...
				b.list.forEach(function(b) {
					$.get(`/newUser?id=${b._id}`, function(n) {
						d.append(c = $("<tr>").attr("id", ["ur", b._id].join("-"))), c.append($("<td>").append(a("ud-" + b._id + "-_id", "g", b._id))).append($("<td>").append(a("ud-" + b._id + "-money", "g", b.money))).append($("<td>").append(a("ud-" + b._id + "-kkutu", "l", JSON.stringify(b.kkutu || {})))).append($("<td>").append(a("ud-" + b._id + "-box", "l", JSON.stringify(b.box || {})))).append($("<td>").append(a("ud-" + b._id + "-equip", "l", JSON.stringify(b.equip || {})))).append($("<td>").append(a("ud-" + b._id + "-nickname", "g", b.nickname))).append($("<td>").append(a("ud-" + b._id + "-server", "t", b.server))).append($("<td>").append(a("ud-" + b._id + "-lastLogin", "t", b.lastLogin))).append($("<td>").append(a("ud-" + b._id + "-black", "g", b.black))).append($("<td>").append(a("ud-" + b._id + "-friends", "g", JSON.stringify(b.friends || {})))).append($("<td>").append(a("ud-" + b._id + "-newuser", "g", n.newUser)))
					})
				})
			})
			...
			$.get("/gwalli/reports", function(b) {
				...
				for(c in f){
					...
					d.append(s = $("<tr>")), s.append($("<td>").attr("id","submitter-"+o.submitter).text(o.submitter)).append($("<td>").attr("id","target-"+o.target).text(o.target)).append($("<td>").attr("id","reason-"+o.reason).text(o.reason)).append($("<td>").attr("id","date-"+o.date).text(o.date))
				}
			})
			...
			$("#user-data tr:visible").each(function(a, c) {
				...
				b.push({
					...
					black: d.get(8).value,
					friends: d.get(9).value,
					newuser: d.get(10).value
				})
			}), $.post("/gwalli/users", {
				list: JSON.stringify({
					list: b
